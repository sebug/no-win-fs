            ...
            return function (__dict_MonadReader_11) {
                return function (__dict_MonadWriter_12) {
                    return function (__dict_MonadState_13) {
                        return new MonadRWS(function () {
                            return Control_Monad_Reader_Class.monadReaderErrorT(__dict_Monad_8)(__dict_MonadReader_11);
                        }, function () {
                            return Control_Monad_State_Class.monadStateErrorT(__dict_Monad_8)(__dict_MonadState_13);
                        }, function () {
                            return Control_Monad_Writer_Class.monadWriterErrorT(__dict_Monad_8)(__dict_MonadWriter_12);
                        }, function () {
                            return __dict_Monoid_9;
                        }, function () {
                            return Control_Monad_Error_Trans.monadErrorT(__dict_Monad_8);
                        });
                    };
                };
            };
